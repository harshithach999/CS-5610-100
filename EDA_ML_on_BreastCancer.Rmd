...
```{r}
CalcTrain <- read.csv("calc_case_description_train_set.csv",stringsAsFactors = FALSE)
CalcTest <- read.csv("calc_case_description_test_set.csv",stringsAsFactors = FALSE)
```
...
```{r}
MassTrain <- read.csv("mass_case_description_train_set.csv",stringsAsFactors = FALSE)
MassTest <- read.csv("mass_case_description_test_set.csv",stringsAsFactors = FALSE)
```
